package me.yex.common.client.util;
...
public class TokenUtil {
    ...
    public String getRefreshAuthKey(UserInfo userInfo, Date lastLoginTime) {
        return String.format("%s:%s", AuthConstant.TokenConstant.REFRESH_AUTH, JWTUtil.create(userInfo, lastLoginTime, AuthConstant.TokenConstant.REFRESH));
    }
